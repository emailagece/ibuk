 ...
 *
 */
(function(e){if(!e.browser){var p;p=navigator.userAgent||"";e.uaMatch=function(e){e=e.toLowerCase();e=/(chrome)[ \/]([\w.]+)/.exec(e)||/(webkit)[ \/]([\w.]+)/.exec(e)||/(opera)(?:.*version)?[ \/]([\w.]+)/.exec(e)||/(msie) ([\w.]+)/.exec(e)||0>e.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+))?/.exec(e)||[];return{browser:e[1]||"",version:e[2]||"0"}};p=e.uaMatch(p);e.browser={};p.browser&&(e.browser[p.browser]=!0,e.browser.version=p.version);e.browser.webkit&&(e.browser.safari=!0)}})(jQuery);
jQuery.easing.jswing=jQuery.easing.swing;jQuery.extend(jQuery.easing,{easeOutCubic:function(e,p,v,q,n){return q*((p=p/n-1)*p*p+1)+v},easeOutExpo:function(e,p,v,q,n){return p==n?v+q:q*(-Math.pow(2,-10*p/n)+1)+v}});
...
event.propertyName&&(a.document.title=n.title)}catch(b){}})};m.stop=b;d=function(){return q(a.location.href)};c=function(b,c){var d=a.document,g=e.fn.hashchange.domain;b!==c&&(d.title=n.title,d.open(),g&&d.write('<script>document.domain="'+g+'"\x3c/script>'),d.close(),a.location.hash=b)}}();return m}()})(jQuery,this);
...
pdfProgressiveRender:!1,onPDFLoadError:null,zoomLevel:1,zoomMax:2,zoomMin:1,zoomBoundingBox:window,zoomStep:.25,zoomDuration:200,zoomEasing:"linear",onZoom:null,pinchToZoom:!0,allowDragBrowserPageZoom:!1,flipSound:!0,flipSoundFile:["https://raw.githubusercontent.com/emailagece/ibuk/master/css/sound/page-flip.mp3","https://raw.githubusercontent.com/emailagece/ibuk/master/css/sound/page-flip.ogg"],flipSoundPath:"",onPlayFlipSound:null,keyboardNavigation:{back:37,advance:39},clipBoundaries:!0,onShowPage:null,onHoldPage:null,onReleasePage:null,pagesInMemory:null,pagesToKeep:null,onLoadPage:null,onUnloadPage:null,lightbox:null,
...
"translate3d("+a+"px, "+b+"px, "+(c||0)+"px) ":"translate("+a+"px, "+b+"px) "},isMobile:function(){return 480>=e(window).width()||480>=e(window).height()}}})(jQuery);
...
v.removeClass(q);e("body").append("<style>"+w+"</style>")}}else alert("jQuery 1.4.3+ is needed for this plugin to work")})(jQuery);